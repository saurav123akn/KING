...
OWNER_USERNAME = getenv("OWNER_USERNAME","King_oF_Heartx")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME" , "QueenXmusic143_bot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "KingXQueen")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME" , "KingXQueen_music")
...
LOGGER_ID = int(getenv("LOGGER_ID", -1002101086209))

# Get this value from  on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", 6737310448))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/saurav123akn/KING",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/black_king143")
